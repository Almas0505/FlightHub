"""
Django settings for booking service
"""
import os
...
CELERY_BROKER_URL = os.getenv('CELERY_BROKER_URL', 'amqp://admin:secret@localhost:5672')
...
# Booking settings
BOOKING_EXPIRY_MINUTES = int(os.getenv('BOOKING_EXPIRY_MINUTES', '15'))
MAX_PASSENGERS_PER_BOOKING = int(os.getenv('MAX_PASSENGERS_PER_BOOKING', '9'))

# RabbitMQ for events
RABBITMQ_URL = os.getenv('RABBITMQ_URL', 'amqp://admin:secret@localhost:5672')

# External services
FLIGHT_SEARCH_SERVICE_URL = os.getenv('FLIGHT_SEARCH_SERVICE_URL', 'http://localhost:8001')
